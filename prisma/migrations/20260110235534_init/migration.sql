...
CREATE TABLE "DonationItem" (
    ...
    "donatedQuantity" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "unit" TEXT,
...
CREATE TABLE "Donation" (
    ...
    "isPartialDonation" BOOLEAN NOT NULL DEFAULT false,
    "partialQuantity" DOUBLE PRECISION,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "DonationItem_requiresQuantity_idx" ON "DonationItem"("requiresQuantity");
...
-- CreateIndex
CREATE INDEX "Donation_isPartialDonation_idx" ON "Donation"("isPartialDonation");
